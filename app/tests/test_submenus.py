...
def test_create_submenu_fix(db_create_menus, client):
    ...
    create_submenu(client, menu_id, title="Submenu 1", description="Submenu 1 description")


def test_create_submenu_duplicate(db_create_menus, client):
    menu_id = "00000000-0000-0000-0000-000000000000"
    create_submenu(client, menu_id, title="Submenu 2", description="Submenu 2 description")
